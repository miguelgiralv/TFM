...
$path/software/liftOver \
    $path/results/imputado/extracted/all_positions.txt \
    $path/data/predictXcan/hg38ToHg19.over.chain.gz \
    $path/results/imputado/extracted/positions_hg19.txt \
    $path/results/imputado/extracted/positions_hg19_unlifted.txt

# 2. filtrado con las posiciones de predictdb (FUNCIONA!))
bcftools view \
-R $path/results/imputado/extracted/positions_hg19_nochr.txt \
...
--vcf_genotypes $path/results/imputado/extracted/filtered/chr1.dose_filter.vcf.gz \
--vcf_mode genotyped \
