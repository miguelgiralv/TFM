...
df1=GSM_metadata(894502, 894572).to_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/metadatas/metadata_1.txt", index=False, header=True, sep="\t")
df2=GSM_metadata(894589, 894801).to_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/metadatas/metadata_2.txt", index=False, header=True, sep="\t")
df3=GSM_metadata(894825, 894895).to_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/metadatas/metadata_3.txt", index=False, header=True, sep="\t")
df4=GSM_metadata(894897, 894967).to_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/metadatas/metadata_4.txt", index=False, header=True, sep="\t")
df5=GSM_metadata(894980, 895768).to_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/metadatas/metadata_5.txt", index=False, header=True, sep="\t")

# unimos los dfs en uno único que contiene todos los metadatos:
merged_metadata = pd.DataFrame()
metadata_dir = "C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/metadatas/"
...
check_sex=pd.read_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/GSE33528_sex_check_results.sexcheck", sep="\s+")
check_sex.head()
...
merged_metadata.to_csv("C:/Users/Miguel/Documents/UNIVERSIDAD/6_MASTER_BIOINFORMATICA/TFM/Repositorio/TFM/results/metadata_gsm/merged_metadata.txt", index=False, header=True, sep="\t")
